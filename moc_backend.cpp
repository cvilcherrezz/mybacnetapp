...
QT_MOC_LITERAL(1, 8, 14), // "newTemperature"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "value"
QT_MOC_LITERAL(4, 30, 12) // "generateData"

    },
    "Backend\0newTemperature\0\0value\0"
    "generateData"
};
...
void Backend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newTemperature((*reinterpret_cast< float(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Backend::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Backend::newTemperature)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Backend::newTemperature(float _t1)
{
